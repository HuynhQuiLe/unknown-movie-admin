            ...
            >
              ...
              >
                ...
                <div className="preview-item-content">
                  <p className="preview-subject ellipsis mb-1">User</p>
                </div>
              </a>
              <div className="dropdown-divider" />
              <a className="dropdown-item preview-item" href="/products">
                <div className="preview-thumbnail">
                  <div className="preview-icon bg-dark rounded-circle">
                ...
                <div className="preview-item-content">
                  <p className="preview-subject ellipsis mb-1">Product</p>
                </div>
              </a>
              <div className="dropdown-divider" />
          ...
          <li className="nav-item dropdown border-left">
            ...
            >
              ...
              <a className="dropdown-item preview-item">
                <div className="preview-thumbnail">
                  <img
                    src={user ? user.hinhAnh : "assets/images/faces/face2.jpg"}
                    alt="image"
                    className="rounded-circle profile-pic"
                  />
                </div>
